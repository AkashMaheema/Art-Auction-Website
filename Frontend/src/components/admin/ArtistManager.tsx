...
interface ArtistManagerProps {
  artists: Artist[];
  onCreateArtist: (artist: Omit<Artist, 'id'>) => boolean;
  onUpdateArtist: (id: number, updates: Partial<Artist>) => boolean;
  onDeleteArtist: (id: number) => boolean;
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          ...
          <p className="text-gray-600">Manage featured artists and their profiles</p>
        </div>
            ...
            <div className="p-6">
              <div className="flex items-center justify-between mb-2">
                ...
                <div className="flex items-center space-x-2">
                  {artist.verified && (
                    <Award className="h-5 w-5 text-blue-500" title="Verified Artist" />
                  )}
                  {artist.trending && (
              ...
              <div className="space-y-2 mb-4">
                ...
                <div className="flex justify-between text-sm">
                  ...
                  <span className="font-medium">{formatCurrency(artist.averagePrice)}</span>
                </div>
                <div className="flex justify-between text-sm">
                  <span className="text-gray-500">Total Sales:</span>
                  <span className="font-medium">{formatCurrency(artist.totalSales)}</span>
                </div>
              </div>
